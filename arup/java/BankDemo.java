...
class Account {
    ...
    void withdraw(BigDecimal amount) throws InsufficientFundsException, IllegalArgumentException {
        if (amount.compareTo(BigDecimal.ZERO) <= 0) {
...
class BankingService {
    ...
    public BankingService(Customer customer, Scanner scanner) {
...
public class BankDemo {
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            new BankingService(customer, sc).run();
